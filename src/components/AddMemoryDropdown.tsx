...
export default function AddMemoryDropdown({ onAddContent }: AddMemoryDropdownProps) {
  ...
  const handleFileUpload = () => {
    if (selectedFiles && fileDescription.trim()) {
      ...
      console.log("Uploading files:", selectedFiles, "Description:", fileDescription)
    ...
    <>
      ...
      <Dialog open={uploadModalOpen} onOpenChange={setUploadModalOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="file-description" className="text-sm text-muted-foreground">
                Description
              </Label>
              <Textarea
                id="file-description"
      ...
      <Dialog open={connectModalOpen} onOpenChange={setConnectModalOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Connect your accounts and services to automatically import your data and expand your AI's knowledge.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={contentModalOpen} onOpenChange={setContentModalOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Start a new conversation topic with your AI trainer. Give it a title and description, 
              then the AI will help you develop the content through conversation.
            </DialogDescription>
          </DialogHeader>
          
          <div className="space-y-4">
            <div>
              <Label htmlFor="content-title" className="text-sm text-muted-foreground">
                Title
              </Label>
              <Input
                id="content-title"
            ...
            <div>
              <Label htmlFor="content-desc" className="text-sm text-muted-foreground">
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                Once you add this, the AI will help you write the content through conversation.
              </p>
            </div>
          </div>
      ...
      <Dialog open={instructionModalOpen} onOpenChange={setInstructionModalOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="instruction" className="text-sm text-muted-foreground">
                Instruction
              </Label>
              <Textarea
                id="instruction"
