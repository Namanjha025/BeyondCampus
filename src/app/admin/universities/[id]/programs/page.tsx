        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPrograms.length === 0 ? (
            ...
            filteredPrograms.map((p) => (
              <div
                key={p.id}
                className="bg-[#0f0f0f] border border-gray-800 rounded-2xl p-6 hover:border-primary/30 transition-all group"
              >
                ...
                <div className="space-y-3 pt-4 border-t border-gray-800/50">
                  <div className="flex items-center gap-3 text-sm text-gray-400">
                    ...
                    <span>
                      Duration:{' '}
                      {p.durationMonths ? `${p.durationMonths} Months` : 'N/A'}
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-400">
                    ...
                    <span>
                      Tuition:{' '}
                      {p.tuitionPerYear
                        ? `$${p.tuitionPerYear.toLocaleString()}/Year`
                        : 'Check Site'}
                    </span>
                  </div>
                </div>
