    ...
    achievements: [
      {
        ...
        description:
          'Recognized for developing an AI-powered code review system that improved team productivity by 40%',
        date: '2024-03-15',
        category: 'award',
      },
      {
        ...
        description:
          'Achieved professional-level certification in AWS cloud architecture',
        date: '2023-11-20',
    ...
    experience: [
      {
        ...
        company: 'Tech Corp',
        description:
          'Lead full-stack development team, architected microservices infrastructure',
        startDate: '2022-01',
        endDate: '',
        current: true,
      },
