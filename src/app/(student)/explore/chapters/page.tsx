              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    • {totalWordCount.toLocaleString()} words written
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="p-6 border-b border-[hsl(0_0%_18%)]">
                  <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span>
                            Updated{' '}
                            {new Date(
                              selectedChapterData.lastUpdated
                            ).toLocaleDateString()}
                          </span>
                        </div>
                        <div className="flex items-center gap-1">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/explore/train?chapter=${selectedChapterData.id}`
                        )
                      }
                    >
                          ...
                          .map((paragraph, index) => {
                            ...
                            if (
                              ...
                              return (
                                <blockquote
                                  key={index}
                                  className="border-l-4 border-primary pl-4 my-6 italic text-gray-400"
                                >
                                  {paragraph}
                                </blockquote>
                              );
