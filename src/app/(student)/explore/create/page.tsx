      ...
      <div className="max-w-2xl mx-auto p-8 pt-16">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({ ...formData, twinName: e.target.value })
              }
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  value: 'witty',
                  label: 'Witty',
                  desc: 'Clever with a sense of humor',
                },
                {
                  value: 'other',
                  label: 'Custom',
                  desc: 'Define your own personality',
                },
              ].map((option) => (
                <button
                  key={option.value}
          ...
          <div>
            ...
            {formData.tone === 'other' && (
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, customTone: e.target.value })
                }
                className="mt-4 w-full h-10 bg-[#0d1117] border-[hsl(0_0%_18%)] text-white placeholder:text-muted-foreground focus:border-primary/50"
              />
            )}
          ...
          <div>
            ...
            <div className="bg-[hsl(0_0%_6%)] border border-[hsl(0_0%_18%)] rounded-lg p-4">
              <p className="text-xs text-muted-foreground mb-4">
                Add important links for your twin to reference (portfolio,
                social media, etc.)
              </p>
              ...
              {formData.links.length > 0 && (
                <div className="space-y-2 mb-4">
                  {formData.links.map((link, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between bg-[#0d1117] border border-[hsl(0_0%_24%)] rounded-lg p-3"
                    >
          ...
          <div>
            ...
            <div className="bg-[hsl(0_0%_6%)] border border-[hsl(0_0%_18%)] rounded-lg p-4">
              <p className="text-xs text-muted-foreground mb-4">
                Record a voice note to help your AI twin understand your
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">
                          Ready to train your twin's voice
                        </div>
                      </div>
                    </div>
                    <button
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="text-center space-y-2">
            <p className="text-xs text-muted-foreground">
              <strong>Publish:</strong> Your twin goes live at beyondcampus.com/
              {formData.twinName.toLowerCase().replace(/\s+/g, '-') ||
                'your-name'}
            </p>
            <p className="text-xs text-muted-foreground">
              <strong>Start Training:</strong> Train your twin privately before
              making it public
            </p>
          </div>
        </div>
