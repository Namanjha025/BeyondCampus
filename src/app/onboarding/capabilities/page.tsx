...
const capabilities = [
  {
    ...
    description: 'Maya remembers your goals, preferences, and timeline to provide tailored advice for your unique journey',
  ...
  },
  {
    ...
    description: 'Discover universities that match your profile, budget, and aspirations across multiple countries',
  ...
  },
  {
    ...
    description: 'Get help with essays, SOPs, and documents. Maya guides you through each application step',
  ...
  },
  {
    ...
    description: 'Never miss a deadline. Maya tracks important dates and reminds you what needs attention',
  ...
  },
  {
    ...
    description: 'Visualize your journey with clear milestones and actionable next steps',
  ...
  },
  {
    ...
    description: 'Connect with students who have walked this path. Learn from their experiences',
        ...
        >
          <div className="mb-6">
            <div className="flex items-center justify-center gap-3 text-green-400 mb-2">
              ...
              <span className="text-base">Your profile is set up and Maya is ready!</span>
            </div>
