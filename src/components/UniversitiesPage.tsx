...
export default function UniversitiesPage() {
  ...
  const categories = [
    ...
    {
      id: 'ivy',
      title: 'Ivy League Schools',
      universities: universities.filter((u) => u.category === 'ivy'),
    },
    {
      id: 'tech',
      title: 'Tech-Focused Universities',
      universities: universities.filter((u) => u.category === 'tech'),
    },
    {
      id: 'public',
      title: 'Top Public Universities',
      universities: universities.filter((u) => u.category === 'public'),
    },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div
          ref={contentRef}
          className="flex-1 overflow-y-auto bg-[#050505] relative"
        >
          <div className="p-8">
            {isLoading ? (
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          {category.id === 'ivy' &&
                            'Elite institutions with rich history and tradition'}
                          {category.id === 'tech' &&
                            'Leading the innovation in STEM fields'}
                          {category.id === 'public' &&
                            'Excellence in education with affordable tuition'}
                        </p>
                      </div>
                      <Button
                        variant="ghost"
