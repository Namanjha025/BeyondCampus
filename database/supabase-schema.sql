...
CREATE TABLE public.twin_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_twins_status ON public.twins(status);
CREATE INDEX idx_twins_public_url ON public.twins(public_url);
CREATE INDEX idx_sessions_twin_id ON public.twin_sessions(twin_id);
CREATE INDEX idx_sessions_type ON public.twin_sessions(type);
CREATE INDEX idx_sessions_status ON public.twin_sessions(status);
