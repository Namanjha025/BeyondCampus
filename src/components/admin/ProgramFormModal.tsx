...
export default function ProgramFormModal({
  ...
  const inputStyle =
    'bg-[#050505] border-gray-800 text-white focus:border-primary/50';
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className={cn(
                  inputStyle,
                  'w-full rounded-md h-10 px-3 py-2 text-sm outline-none border focus:border-primary/50 transition-all'
                )}
              >
